...
import SortDropDownData from '@/modules/product/categories/list/sort-dropdown.json';
import tableColumnsListData from '@/modules/product/categories/list/table-columns.json';
...
const Categories = () => {
  ...
  const {
    ...
    isError,
    isFetching,
  } = useGetCategoryQuery(queryParam);
  const [deleteCategory] = useDeleteCategoryMutation();
  const [bulkStatusChange] = useBulkStatusChangeCategoryMutation();
    ...
    },
    {
      ...
      render: (data) => (
        <div style={{ display: 'flex', gap: '10px' }}>
          <button>
            {' '}
            <RiEditLine size={20} onClick={() => handleEditCategory(data)} />
          </button>
          <button
            onClick={() => {
  ...
  const onSelectionButtons: OnSelectionButton[] = [
    {
      ...
      action: () => {
        Modal.confirm({
          title: 'Force Delete Categories',
          content:
            'Are you sure you want to delete these categories? Deleting this will permanently remove the data.',
          okText: 'Yes',
          okType: 'danger',
          cancelText: 'No',
          onOk: () => handleDeleteCategory(ids),
        });
      },
      isDefault: true,
    },
    {
      ...
      action: () => {
        Modal.confirm({
          ...
          content: 'Are you sure you want to activate these categories?',
          okText: 'Yes',
          okType: 'danger',
          cancelText: 'No',
    ...
    },
    {
      ...
      action: () => {
        Modal.confirm({
          ...
          content: 'Are you sure you want to draft these categories?',
          okText: 'Yes',
          okType: 'danger',
          cancelText: 'No',
